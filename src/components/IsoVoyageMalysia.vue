  ...
  <div class="hello relative content">
    ...
    <div id="voyage_1" class="container">
      <div class="row mb-8 flex">
        ...
        <div class="col-sm-3 mb-4 gri-img img-malysia">
        </div>
        <div class="col-sm-3 mb-4 gri-img img-malysia-1 picture-001">
        </div>
        <div class="col-sm-3 mb-4 gri-img img-malysia-2 picture-001">
        </div>         
        ...
        <div class="col-12">
          <h1 class="title-voyage-detail mt-8 mb-4">
            Details de voyage Omra & Malysia
          </h1>
        </div>
      </div>
