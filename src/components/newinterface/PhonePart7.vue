    ...
    <div class="phoneIcnns my-4">
        <div class="flex">
                <div class="row d-flex justify-content-center align-items">
                  <div class="col-2">
                    <p class="mb-3 thistt"><img src="/inso-pics/dz.png"
                      style="border-radius: 100%;display: inline;width: 40px;" alt="">                    </p>
                  </div>
                  <div class="col-8">
                  <p class="mb-3 thistt">
                    Creche en Algerie 
                ...
                <div class="filtering flex lg:flex-nowrap flex-wrap justify-between mt-10 items-center flex-col-reverse lg:flex-row" style="width: 100%;">
                  ...
                  <!--
                    <div class="aaqsze pb-1">
                    <img class="lg:mx-5 mx-2 2xl:w-8 w-5" src="/inso-pics/asss.png" alt="" style="height: auto;object-fit: contain;">
                    <div>
                      <div class="flex justify-around py-1 flex-col items-center">
                          <a href="tel:+213556000023" class="lg:text-start text-center lg:font-normal font-semibold cursor-pointer">ISO ASSURANCE Will Guide you</a>
                      </div>
                      
                  </div>
                  <img class="lg:mx-5 mx-2 2xl:w-8 w-5" src="/inso-pics/logo-visit-phone.png" alt="" style="height: auto;object-fit: contain;">
                </div>
                  -->
              </div>
            </div>
