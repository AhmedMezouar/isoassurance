...
declare type BuiltInIconProps = HTMLOrSVGElement & IconProps;
declare type Content = string | VNode | ((props: ToastContentProps) => VNode) | DefineComponent<{}, {}, any>;
declare type ToastFunc = {
    (content: Content, options?: ToastOptions): void;
};
declare type Id = number | string;
declare type ToastType = 'info' | 'success' | 'error' | 'warning' | 'loading' | 'default';
declare type ToastPosition = 'top-left' | 'top-right' | 'top-center' | 'bottom-left' | 'bottom-right' | 'bottom-center';
declare type ToastTransition = 'zoom' | 'flip' | 'bounce' | 'slide';
declare type ToastTheme = 'auto' | 'light' | 'dark' | 'colored';
...
declare type IconType = boolean | string | number | VNode | ((props: IconProps) => VNode) | DefineComponent<IconProps, {}, {}>;
declare type CloseBtnType = boolean | ((props: CloseButtonProps) => VNode) | DefineComponent<IconProps, {}, {}>;
/**
 * options for toast
 */
interface Options {
...
declare type ToastItemStatus = 'added' | 'removed' | 'updated';
interface Toast {
    content: Content;
    props: ToastOptions;
}
...
declare type ToastContent<T = unknown> = string | VNode | ((props: ToastContentProps<T>) => string | VNode) | DefineComponent<{}, {}, any> | (() => string);
...
declare type NotValidatedToastProps = Partial<ToastOptions>;
declare type OnAddCallback = (content: Content, options: NotValidatedToastProps) => void;
declare type OnRemoveCallback = (id: Id) => void;
declare type OnClearAllQueueCallback = (containerId?: Id) => void;
declare type OnUpdateCallback = (toast: UpdateOptions) => void;
declare type Callback = OnAddCallback | OnRemoveCallback | OnClearAllQueueCallback | OnUpdateCallback;
